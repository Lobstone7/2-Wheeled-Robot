...
const uint32_t vector[] __attribute__((section(".isr_vector"))) = {              //__attribute__ is used to create separate section for vector table so that it doesnt end up in data section
    (uint32_t)&_estack,
